...
<!-- Navigation menu !-->
<nav class="navbar navar-expand-md navbar-dark bg-dark item">
    <div>
        <ul class="nav menu_list" role="tablist" >
            ...
            <li class=" menu_item">
                <a data-target="#register_box" class="" role="tab" data-toggle="modal">Cars</a>
            </li>
            <li class=" menu_item">
                <a data-target="#login_box" class="" role="tab" data-toggle="modal">Something else</a>
            </li>
        </ul>
    </div>
    ...
    <div>
        <ul class="nav menu_list " role="tablist">
            <li class="nav-item menu_item menu_item2">
                <a data-target="#register_box" class="" role="tab" data-toggle="modal">Register</a>
            </li>
            <li class="nav-item menu_item menu_item2">
                <a data-target="#login_box" class="" role="tab" data-toggle="modal">Login</a>
            </li>
        </ul>
    </div>
